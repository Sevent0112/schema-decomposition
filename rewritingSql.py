...
def execute(sql: str):
    ...
    with open("./cost.txt", "a", encoding='utf-8') as f:
        f.write(line1 + '\n')
    cur.close()
...
if __name__ == '__main__':
    columns = ['AREA_CODE', 'STATE', 'VOTE_ID', 'PHONE_NUMBER', 'CREATED', 'CONTESTANT_NUMBER', 'CONTESTANT_NAME']
    table_list = [Table(1, "voter_1", [0, 2, 3], [0, 2], []),
                  Table(2, "voter_2", [2, 3, 4, 5], [2, 3], []),
                  Table(3, "voter_3", [0, 1], [0], []),
                  Table(4, "voter_4", [5, 6], [5], [])]
